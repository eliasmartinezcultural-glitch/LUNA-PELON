...
if (!data.includes("VERSION='v0.7.0'")) throw new Error('Dialogue version source is incorrect');
...
if (pkg.version !== '0.7.0') throw new Error(`package.json version mismatch: ${pkg.version}`);
...
if (!engine.includes("../systems/navigation.js") || !engine.includes("../systems/npc.js") || !engine.includes("../systems/time.js") || !engine.includes("../systems/dialogue.js")) throw new Error('Gameplay systems are not connected');
...
if (!state.includes('GAME_SCHEMA_VERSION = 2') || !state.includes('PLAYER_ENTITY_ID') || !state.includes('dialogue')) throw new Error('Persistent narrative state contract failed');
...
if (!dialogue.includes('dialogue:line') || !dialogue.includes('mission:completed') || !dialogue.includes('history')) throw new Error('Dialogue system contract is incomplete');
