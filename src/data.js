...
export const WORLD={
  ...
  roads:[{id:'main-road',x:0,y:650,width:1690,height:105,kind:'road'},{id:'riverside-road',x:1590,y:650,width:620,height:100,kind:'road'},{id:'bridge',x:1690,y:650,width:460,height:100,kind:'bridge'}],
  ...
  obstacles:[{id:'house-marta',x:270,y:420,width:190,height:150},{id:'community-center',x:820,y:360,width:210,height:140},{id:'workshop',x:1180,y:420,width:230,height:150},{id:'river-north',x:1810,y:0,width:220,height:650},{id:'river-south',x:1810,y:750,width:220,height:1500}],
...
export { CAMPAIGN, LOCATIONS, DOORS };
